...
class HomeAdapter(private val context: Context) :  PagingDataAdapter<StoryDB, HomeAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    companion object {
        ...
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<StoryDB>() {
